...
- So in our project we just incorporated to run a loop through all words of the textarea and check for each word and change it if necessary after entering any new word .
